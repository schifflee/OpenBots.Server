...
namespace OpenBots.Server.Business
{
    public interface IMembershipManager : IManager
    {
        ...
        PaginatedList<TeamMember> GetPeopleInOrganization(Guid organizationId, string sortColumn, OrderByDirectionType direction = OrderByDirectionType.Ascending, int skip = 0, int take = 100);
